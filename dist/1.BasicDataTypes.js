...
//---------------------------------------------------------------ARRAY--------------------------------------------//
const array = [];
array.push('this string will be pushed to the array');
array.push('and this string also will be pushed to the array'); //UNCOMMENT to see error, array.push(1) //but if you try with number this will not work! tsc will complain with this message as tooltip-> Argument of type '1' is not assignable to parameter of type 'string'. 
//---------------------------------------------------------------Tuple--------------------------------------------//
...
const functionWithOptionalParameter = (name, age) => {
    if (age) {
